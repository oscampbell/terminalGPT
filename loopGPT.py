...
aiChat = "Your personality/goal is " + personality + ". Come up with a conversational response to the most recent message in the conversation. Try to avoid saying things that will lead to looping conversation. Dont repeat anything that has already been said in the conversation. Ask a new unique question if the conversation is wrapping up, don't let the conversation end. Try to keep output short and snappy."
